#--------------------------------
# Name:         landsat.py
# Purpose:      Common EarthEngine Landsat functions
# Python:       3.6
#--------------------------------
...
class Landsat():
    ...
    def get_image(self, landsat, year, doy, path=None, row=None):
        ...
        output_coll = self.get_collection()
    ...
    def get_collection(self):
        ...
        for landsat in self._landsat_list:
            # Assume iteration will be controlled by changing start_date and end_date
    ...
    def tasumi_sr_func(self, refl_toa):
        ...
        pair = ee.Image(ee_common.pair_func(ee.Image('USGS/SRTMGL1_003')))
        # pair = ee.Image(ee_common.pair_func(ee.Image('USGS/NED')))
