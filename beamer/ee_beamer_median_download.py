#--------------------------------
# Name:         ee_beamer_median_download.py
...
def ee_beamer_et(ini_path=None, overwrite_flag=False):
    ...
    Returns:
        None
    """
    logging.info('\nEarth Engine Beamer Median ETg Image Download')
    ...
    for zone_fid, zone_name, zone_json in zone_geom_list:
        ...
        image_id = 'etg_{}_median'.format(zone_name.lower().replace(' ', '_'))
        ...
        for band in median_band_list:
            ...
            raster_path_set_nodata(median_path, nodata_value)
